...
- Manual launch-critical device checks from [Current State - Release State](release-state.md).
...
Three defects surfaced, all of them pre-existing and all of them latent only because the executor ran ESLint from the workspace root. They are written up as a rule in [Architecture - Nx Workspace](../architecture/nx-workspace.md):
...
All 25 exports were renamed to PascalCase. The rename does not touch a single visual reference: Storybook derives story names with `startCase`, so `imageLoaded` and `ImageLoaded` both yield `Image Loaded`, leaving the story id and every `.loki/reference` filename unchanged. This is recorded in [Implementation - Storybook](../implementation/storybook.md) so a future reviewer does not mistake it for a reference-invalidating change.
...
- The full validation gate is green and remaining exceptions are recorded in [Current State - Known Issues](known-issues.md).
...
[#1030]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1030
[#1031]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1031
[#1032]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1032
[#1033]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1033
[#1034]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1034
[#1035]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1035
[#1036]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1036
...
[#1039]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1039
[#1040]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1040
[#1374]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1374
[#1375]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1375
