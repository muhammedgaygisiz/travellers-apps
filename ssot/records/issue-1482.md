# issue-1482 - feat(brand): version the BiteTribe character set and showcase it in Storybook

Closing record for [#1482].
...
- **The naming is not settled here.** The filenames mix a historical term with national ones. A product vocabulary is a brand decision, so it went to [Current State - Open Questions](../current-state/open-questions.md) rather than into an acceptance criterion.
...
- [Implementation - Brand Characters](../implementation/brand-characters.md): the set, where it lives, how a character is produced, and the two clustering traps.
- [Current State - Open Questions](../current-state/open-questions.md): the naming question and the palette question.
- [Traceability Map](../overview/traceability-map.md) and [SSOT](../README.md) carry the new page.
