...
Execution - Build 89" of [Current State - Release Candidate Test Charter](../current-state/release-candidate-test-charter.md), which
...
- New UX finding: a disabled Save button remains at the bottom even though changes apply immediately and the page can simply be left. This misleading action is tracked by [issue #1217][#1217].
...
- Result: fail. New release-candidate blocker [issue #1219][#1219] tracks the non-terminating registration attempt.
