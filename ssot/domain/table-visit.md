...
- Rules are deployed by hand. Merging a change to `firestore.rules` changes nothing in production until somebody runs the deploy - see [Architecture - Firebase](../architecture/firebase.md).
