...
Libraries are shareable across libraries and applications. They can be imported from `@travellers-apps/mylib`.
...
Run `nx e2e my-app` to execute the end-to-end tests via [Playwright](https://playwright.dev).
