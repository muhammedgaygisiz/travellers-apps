...
- A table has a QR token and no way to ask for one. Issue \#1086 built the generation, rotation, revocation and the rules around them; the editor calls none of it, so a plan carries codes only once the sheet page of issue \#1087 or the publish step of issue \#1088 asks for them.
