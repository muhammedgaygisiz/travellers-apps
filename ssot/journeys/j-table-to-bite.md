...
| 14  | Guest    | Scans the code on the table                                   | `/t/:token` - no story                                                                                                                                                                                                                                                                                                                                              | -                            |
| 15  | Backend  | Resolves the token, or refuses with one of ten reasons        | -                                                                                                                                                                                                                                                                                                                                                                   | `resolveTableQrToken`        |
| 16  | Guest    | Confirms "You are ordering at Sakura Kitchen, table 12"       | `/t/:token` - no story                                                                                                                                                                                                                                                                                                                                              | -                            |
...
| 19  | Guest    | Reads the menu, sold-out dishes marked and not addable        | `/t/:token/order`, or `/m/:id` with no account - [Menu / Ordering At A Table](../../.loki/reference/chrome_iphone7_Components_Menu_Ordering_At_A_Table.png), [Read Only For A Guest](../../.loki/reference/chrome_iphone7_Components_Menu_Read_Only_For_A_Guest.png), [Pages / Menu / Unavailable](../../.loki/reference/chrome_iphone7_Pages_Menu_Unavailable.png) | `loadPublicMenu`             |
| 20  | Guest    | Builds a cart and submits the order                           | `/t/:token/order` - no story                                                                                                                                                                                                                                                                                                                                        | `submitTableOrder`           |
...
| 22  | Guest    | Watches each order move, and orders again into the same visit | `/t/:token/order` - no story                                                                                                                                                                                                                                                                                                                                        | -                            |
| 23  | Guest    | Asks for help, or asks for the bill                           | `/t/:token/order` - no story                                                                                                                                                                                                                                                                                                                                        | `requestTableAssistance`     |
...
**The guest half of this journey has no visual regression coverage at all.** Steps 14,
16, 20, 22 and 23 - scanning, confirming the table, building and sending the cart,
watching an order move, asking for the bill - are the guest's whole experience of the
product, and not one of them has a reference image. Every owner and staff surface it
passes through does. That asymmetry is a finding about the suite rather than about the
journey, and it is recorded here because this is the first page to put the two halves
side by side.
