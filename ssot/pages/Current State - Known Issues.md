...
| Currency quality     | [[issue-909]] now prefills currency from Bite location and [[issue-967]] warns about suspicious prices; fallback, manual override, and travel/border edge cases still need final proof. | Prices should make sense for the place where a Bite was created or experienced.    |
