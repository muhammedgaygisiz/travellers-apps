# issue-1037 - 11 - chore: upgrade Angular and NgRx to 22 with TypeScript 6

Closing record for [#1037].
...
- Details and the full validation run are recorded in [Current State - Nx And Dependency Migration Roadmap](../current-state/nx-and-dependency-migration-roadmap.md).
...
- Run on 25 August 2026 on a Samsung Galaxy A56 (`SM-A566B`, Android 16, SDK 36), against a production bundle built with `NX_APP_BITE_TRIBE_APP_CHECK_ENFORCED=true` and installed with `nx run bite-tribe-android:run`. Setup steps are in [Implementation - Android Device Testing](../implementation/android-device-testing.md).
...
[#1029]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1029
