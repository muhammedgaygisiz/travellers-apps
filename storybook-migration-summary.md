...
- `npx storybook@latest automigrate --config-dir apps/kosaml/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir apps/prices/.storybook --renderer @storybook/angular`
