# issue-1067 - bugfix: disable pwa for native apps (keep it for web)

Closing record for [#1067].
...
- The durable platform rule is recorded in [Architecture - Capacitor](../architecture/capacitor.md).
