...
was therefore always empty; see [[issue-1371]]. That is also why issue \#266's "assigned users"
...
actually sell is [[UC - Price A BiteTrail For Sale]]; the money a sale produces is
[[UC - Earn From A Paid BiteTrail]]; what a buyer sees and does is
[[UC - Discover BiteTrails In The Marketplace]] and [[UC - Buy A Paid BiteTrail]].
...
- **Bite Creator** - acts: opens the business dashboard, creates a BiteTrail from its own
  ...
  is rewritten from [[User Roles]] when it does.
...
[[Current State - Release Candidate Test Charter]] puts out of scope for this release candidate
...
[[UC - Price A BiteTrail For Sale]], and everything that happens after a sale, which is
...
- Issue \#266, the packaging epic, covered BiteTrail creation from selected Bites, free
  ...
  describes the organisation mechanism [[issue-1371]] removed and no longer exists
...
- [[Personas]] - the food curator or vlogger and the business user this page used to name as
  actors
- [[User Roles]] - the `business` and `staff` roles the door gate tests
- [[UC - Price A BiteTrail For Sale]] - what has to be true before a priced trail can sell
- [[UC - Earn From A Paid BiteTrail]] - the money a sale produces
- [[UC - Discover BiteTrails In The Marketplace]] - how a created trail is found
- [[UC - Buy A Paid BiteTrail]] - the purchase itself
