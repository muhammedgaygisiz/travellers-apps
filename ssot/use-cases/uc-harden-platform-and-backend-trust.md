...
front of Google Places is written down rather than implied ([[issue-1245]]). Still open:
...
[[Architecture - Firebase]]. `storage.rules` is still open to any signed-in account and that is
\#1350, a release risk carried by [[Current State - Known Issues]] rather than classified here.
...
- [[issue-1245]] for the Google Places control and the App Check monitoring reading behind it.
...
- [[Architecture - Firebase]] - the Firestore and Storage rulesets, and the Google Maps
  Platform trust boundary
- [[Current State - Known Issues]] - where the open platform risks are carried
- [[issue-1245]]
