...
- ## A Sold-Out Dish Reads As Available On The Consumer Menu
  ...
  **Why it matters:** the flag is written and enforced, and the one surface a
  ...
  editor. Recorded rather than fixed; [UC - View Restaurant Menus](../use-cases/uc-view-restaurant-menus.md) marks the
  behaviour _Intended, not met_, and the split of ownership is that page for the
  display and [UC - Maintain Restaurants In The Business App](../use-cases/uc-maintain-restaurants-in-the-business-app.md) for the writing.
...
- ## A Deleted Table Leaves Its Live State Behind
  ...
  **Why it matters:** it is the untested half of an epic success criterion, and
  ...
  [epic-1071](../github/epic-1071.md) actually asks: the live view draws states only for tables that
