# issue-1283 - feat: user wants to answer to a review

Closing record for [#1283].
...
- `newReviewReply.title` and `newReviewReply.body` are added to every catalog under `apps/bite-tribe-firebase/functions/src/functions/shared/i18n/messages`. Per [Implementation - Localization](../implementation/localization.md) a missing entry silently falls back to English rather than failing.
...
- Edit, delete and reporting of reviews and replies belong to [epic-1284](epic-1284.md). Deleting a root review that carries replies destroys other people's contributions, so it needs its own rule before it can be built, and [Bite](../domain/bite.md) already records admin moderation as unmodelled today.

## Traceability

- Domain: [Bite](../domain/bite.md)
- Use cases: [UC - Inspect Bite Details](../use-cases/uc-inspect-bite-details.md), [UC - Receive App Notifications And Engagement Updates](../use-cases/uc-receive-app-notifications-and-engagement-updates.md)
- Implementation: [Implementation - Firebase Functions](../implementation/firebase-functions.md), [Implementation - Localization](../implementation/localization.md), [Implementation - Storybook](../implementation/storybook.md)
- Follow-up epic: [epic-1284](epic-1284.md)

## Open Questions

- Recorded in [Current State - Open Questions](../current-state/open-questions.md) under Review Thread Questions.
