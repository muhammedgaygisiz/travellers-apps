...
[Implementation - Store Listing Assets](store-listing-assets.md) owns the listing itself — identity,
copy, screenshots and the per-slot state of both consoles.
[Implementation - Store Release Steps](store-release-steps.md) owns the console procedure.
