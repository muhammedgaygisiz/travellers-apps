...
| Location quality     | City search, address enrichment, mandatory restaurant/place selection, and map live-update camera stability have landed, but real-world location quality still needs testing.  | Discovery, search, restaurant context, and trust depend on usable location data.   |
