...
| [[UC - Use Account And Legal Flows]]                            |       ⬜        |   🟡    | The email verification prompt and its resend offer on settings; the resend call itself needs Workspace mail secrets the emulator has none for, and privacy policy plus account deletion remain                           |
