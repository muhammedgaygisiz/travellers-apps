# issue-1387 - bug: Native analytics collection stays disabled on devices that ran a dev build

Closing record for [#1387].
...
- Recorded as the Collection Flag Rule and the Transport Rule in [Architecture - Analytics](../architecture/analytics.md).
