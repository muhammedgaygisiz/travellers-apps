...
belongs to [[UC - Receive App Notifications And Engagement Updates]].
...
- **Language** - the app's language, and the same saved choice the Localization Contract in
  [[UC - Receive App Notifications And Engagement Updates]] reads when it translates a
...
classified `[MVP]` by [[UC - Receive App Notifications And Engagement Updates]] and this is the
...
- [[Personas]] - the audiences the `Actors` mapping displaced: the food lover and the traveler
- [[UC - Receive App Notifications And Engagement Updates]] - the delivery state this page's
  notification list switches, and the Localization Contract that reads the saved language
- [[UC - Guide New Users After Registration]] - where the location permission is collected
- [[UC - Discover Bites]] - the Home feed whose optional nearby filter reads `Settings.nearby`
- [[Implementation - Store Declarations]]
