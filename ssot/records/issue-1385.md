# issue-1385 - bug: Android resolves the sign-in provider to unknown, so account deletion can never re-authenticate

Closing record for [#1385].
Written before the [Closing Report](../overview/github-issue-format.md#closing-report) rule; kept as-is, not extended.

## Description

- Found in [Test Run 09 - Android Build 95](../test-runs/09-android-build-95.md), the Android first execution, on Play Open Testing build 1.0.1 (95) from tag `build-1.0.1-95`, on a physical Samsung SM-A566B running Android 16.
