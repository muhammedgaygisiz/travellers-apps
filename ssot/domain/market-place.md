...
- A paid BiteTrail sells through store in-app purchase, and its Bites stay locked until the purchase is verified. A non-buyer sees a preview only. See [Monetization](../product/monetization.md) and [epic-1125][#1125].
