...
capabilities are sold, and why that split is fair, is [[Monetization]]; the entitlement record
and the Free/Pro capability matrix are issues \#1122 and \#1126; the ads a Pro subscriber
stops seeing are [[UC - See Ads As A Free User]]; and a one-off purchase of a curated trail,
which reuses these rails without being a subscription, is [[UC - Buy A Paid BiteTrail]].
...
Not on this page: which capabilities are sold, which is [[Monetization]]'s, and the ad
removal a subscription causes, which is [[UC - See Ads As A Free User]]'s.
