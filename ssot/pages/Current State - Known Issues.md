...
| Location quality     | City search, address enrichment, mandatory restaurant/place selection, and map live-update camera stability have landed; issue 902 now tracks source-aware selected-place mismatch warnings if real-world testing shows users still publish Bites at the wrong position. | Discovery, search, restaurant context, and trust depend on usable location data.   |
