...
[[UC - Mature BiteTrail Marketplace Packages]], which shows the creator what a sale will yield
...
- **Bite Creator** - acts: completes payout onboarding, earns from each sale, and reads the
  ...
  rewritten from [[User Roles]] when it does.
...
- A creator is payable only once identity verification, payout onboarding and creator terms are complete. The gate that stops an unpayable creator publishing is [[UC - Mature BiteTrail Marketplace Packages]]'s.

## MVP Classification

**[Secondary]** - the whole page. Priority P1 and post-launch by its own Status,
[[Current State - Roadmap]] puts the whole of [[Monetization]] there, and no paid BiteTrail
...
[[UC - Mature BiteTrail Marketplace Packages]], and the purchase that triggers a sale, which is
...
- [[Personas]] - the food curator or vlogger this behaviour used to be described for
- [[Monetization]] - the revenue-share rule and the free and paid boundary. A product page, not
  a domain
...
- [[UC - Mature BiteTrail Marketplace Packages]] - pricing and publishing, and the gate that
