...
- ## Event Reference
  ...
  | Account    | `account_deletion_failed`             | `reason: 'reauth_required' \| 'reauth_failed' \| 'unknown'`                  | Deletion needs a fresh sign-in, or fails outright            | `libs/bite-tribe/account/data-access/.../delete-my-account.service.ts`       |
