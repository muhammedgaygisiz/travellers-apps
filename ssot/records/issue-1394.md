# issue-1394 - Use the Android Photo Picker for the gallery path

Closing record for [#1394].
Written before the [Closing Report](../overview/github-issue-format.md#closing-report) rule; kept as-is, not extended.

## Description

- Found in [Test Run 09 - Android Build 95](../test-runs/09-android-build-95.md), the Android first execution, on Play Open Testing build 1.0.1 (95), on a physical Samsung SM-A566B running Android 16 (SDK 36).
...
- Recorded as the Media Permission Rule on [Architecture - Capacitor](../architecture/capacitor.md), and as flow bullets on [UC - Create And Maintain Personal Bites](../use-cases/uc-create-and-maintain-personal-bites.md).
