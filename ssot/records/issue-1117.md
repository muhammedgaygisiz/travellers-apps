# issue-1117 - bugfix(business): click on restaurant candidate causes error and second click opens a broken page

Closing record for [#1117].
...
- The durable rule is recorded in [Architecture - State Management](../architecture/state-management.md).
...
[#1117]: https://github.com/muhammedgaygisiz/travellers-apps/issues/1117
