# issue-1393 - bug: Photo source action sheet lists Cancel before the real actions

Closing record for [#1393].
...
- Recorded as a rule on [Implementation - Ionic Patterns](../implementation/ionic-patterns.md).
