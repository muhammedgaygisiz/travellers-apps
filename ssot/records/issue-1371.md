# issue-1371 - chore: cleanup Organisation properties in user model

Closing record for [#1371].
...
- `organisationId` was queried by the business app's organisation dashboard to list "employees" but was never declared on `PublicUser`. Firestore field paths are strings, so TypeScript never caught it. [epic-1069](epic-1069.md) recorded as fact that "`users` and `biteTrails` already carry `organisationId`" and proposed organisation-held restaurant ownership on that premise. The premise was false: `BiteTrail` carries `ownerId` and no organisation field at all.
...
- The SSOT no longer models an organisation profile type or organisation-held ownership. [User](../domain/user.md), [Glossary](../product/glossary.md), [Personas](../product/personas.md), [Restaurant](../domain/restaurant.md), [Bite Trail](../domain/bite-trail.md), [Market Place](../domain/market-place.md), [Floor Plan](../domain/floor-plan.md), [epic-1069](epic-1069.md), [epic-735][#735], [epic-1121][#1121], [epic-1125][#1125], [UC - Own And Claim Restaurants](../use-cases/uc-own-and-claim-restaurants.md), and the affected use-case pages are updated. Generic prose naming organisations as a business audience in [Mission](../product/mission.md), [Principles](../product/principles.md), [Monetization](../product/monetization.md), and [Subscription](../domain/subscription.md) is left alone; it describes who the product serves, not a modeled entity.
